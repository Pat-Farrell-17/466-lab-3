import dTreeNumeric as c45, math, parsing, copy, sys
...
def main():
    ...
    d = parsing.parseData(sys.argv[1])
    dataPoints = d[0]
    attributes = d[1]

    classifications = classifyData(dataPoints, int(sys.argv[2]))
    print((len(dataPoints) - numErrors(classifications)) / len(dataPoints))
